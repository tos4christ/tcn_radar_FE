...
class HourlyTable extends React.Component {
  ...
  render() {    
    return (
      ...
      <h1> 330kv panel</h1>       
        <nav>
          <Link to={`${this.props.match.url}/linecurrent`}> 330kv Line Current upload </Link>
          <Link to={`${this.props.match.url}/linevoltage`}> 330kv Line Voltage upload </Link>
          <Link to={`${this.props.match.url}/linepower`}> 330kv Line Power Upload </Link>
          <Link to={`${this.props.match.url}/txfrcurrent`}> 330kv Transformer Current upload </Link>
          <Link to={`${this.props.match.url}/txfrvoltage`}> 330kv Transformer Voltage upload </Link>
          <Link to={`${this.props.match.url}/txfrpower`}> 330kv Transformer Power Upload </Link>
          <Link to={`${this.props.match.url}/txfrtap`}> 330kv Transformer Tap upload </Link>
          <Link to={`${this.props.match.url}/reactor`}> 330kv Reactor MX upload </Link>
          <Link to={`${this.props.match.url}/profile`}> 330kv Profile download </Link>
          <Link to={`${this.props.match.url}/reports`}> 330kv Report upload </Link>
          <Link to={`${this.props.match.url}/outages`}> 330kv Outage request upload </Link>
      </nav>
